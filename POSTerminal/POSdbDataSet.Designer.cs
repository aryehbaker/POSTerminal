...
SELECT Id, OrderId, Amount, DateOfPayment FROM Payments WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT SUM(Amount) AS Expr2\r\nFROM   Payments\r\nGROUP BY OrderId\r\nHAVING (OrderId =" +
                " @orderId)";
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual global::System.Nullable<decimal> SumPayed(global::System.Nullable<int> orderId) {
